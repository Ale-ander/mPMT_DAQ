...
#
# Generated by Vivado on Fri Mar 22 16:39:01 +0100 2024
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../mPMT_DAQ.srcs/sources_1/ip/clk_wiz_0" \
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../../mPMT_DAQ.srcs/sources_1/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl" \
  2>&1 | tee -a vhdlan.log
