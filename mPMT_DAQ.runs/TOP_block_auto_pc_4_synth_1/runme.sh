...
HD_PWD='C:/Users/alexa/OneDrive/Desktop/Vivado_projects/mPMT_DAQ/mPMT_DAQ.runs/TOP_block_auto_pc_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TOP_block_auto_pc_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TOP_block_auto_pc_4.tcl
