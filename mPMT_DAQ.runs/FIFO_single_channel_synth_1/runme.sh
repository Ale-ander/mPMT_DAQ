...
HD_PWD='C:/Users/alexa/OneDrive/Desktop/Vivado_projects/mPMT_DAQ/mPMT_DAQ.runs/FIFO_single_channel_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FIFO_single_channel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FIFO_single_channel.tcl
